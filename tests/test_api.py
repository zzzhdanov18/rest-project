...
test_submenu_id = ""
test_dish_id = ""
base_url = "http://fast-api-app:80/api/v1/menus"
...
def test_create_menu():
    ...
    response = requests.post(base_url, json=created_menu)
...
def test_update_menu():
    ...
    response = requests.patch(url, json=updated_menu)
...
def test_create_submenu():
    ...
    response = requests.post(url, json=create_submenu)
...
def test_update_submenu():
    ...
    response = requests.patch(url, json=update_submenu)
...
def test_create_dish():
    ...
    response = requests.post(url, json=create_dish)
...
def test_update_dish():
    ...
    response = requests.patch(url, json=update_dish)
